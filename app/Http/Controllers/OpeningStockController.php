        ...
        try {
            DB::transaction(function () use ($request, &$stockIn) {
                ...
                */
                ...
                // Capacity validation handled dynamically by WarehouseRowFifo (fills target row up to capacity, then automatically forwards overflow to next row/warehouse)

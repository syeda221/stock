    ...
    <div class="col-12">
        <div class="d-flex justify-content-between align-items-center mb-2">
            ...
            <div class="d-flex align-items-center gap-2">
                <span style="font-size: 13px; color: #64748b;">{{ date('D, M d, Y') }}</span>
                    ...
                    <table class="table table-hover mb-0" style="font-size: 12px;">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ optional($item->expiry_date)->format('M d, Y') }}</td>
                            ...
                            <tbody>
                                @foreach($recentInbound as $inbound)
                                    <tr>
                                        ...
                                        <td style="padding: 0.5rem 0.75rem; color: #64748b;">{{ $inbound->created_at->format('M d, Y') }}</td>
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
                            ...
                            <tbody>
                                @foreach($recentOutbound as $outbound)
                                    <tr>
                                        ...
                                        <td style="padding: 0.5rem 0.75rem; color: #64748b;">{{ $outbound->created_at->format('M d, Y') }}</td>
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
                        ...
                        <table class="table table-hover mb-0" style="font-size: 13px;">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="padding: 0.5rem 0.75rem; color: #64748b;">{{ $feed['date']->format('M d, Y H:i') }}</td>
                                </tr>
                                @endforeach
                            </tbody>
                        </table>

...
<div class="row g-3">
    <div class="col-12">
        <div class="d-flex justify-content-between align-items-center mb-2">
            <div>
                <h4 class="fw-bold mb-1">Import Opening Stock</h4>
            ...
            <a href="{{ route('opening-stock.index') }}" class="btn btn-sm btn-outline-secondary">
    ...
    <div class="col-md-8">
        <div class="card">
            <div class="card-header border-bottom-0 pt-3 px-3">
                <h6 class="fw-semibold mb-0">Upload Opening Stock CSV</h6>
            </div>
            <div class="card-body px-3">
                <form action="{{ route('opening-stock.import.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        <label class="form-label fw-semibold small">Warehouse <small class="text-muted">(leave empty to auto-assign)</small></label>
                    ...
                    <div class="mb-3">
                        ...
                        <small class="text-muted">Upload a CSV file. <a href="{{ route('opening-stock.import.template') }}">Download template</a></small>
                        @error('csv_file')
                    ...
                    <div class="mb-3">
                        ...
                        <div style="font-size: 13px; background: #f8fafc; padding: 1rem; border-radius: 8px;">
                            ...
                            <code style="font-size: 12px;">Item Code, Units Received, SAP Batch, Vendor Batch, MFG Date, Expiry Date, Quality Clearance, Blocked, Hold, Remarks</code>
                            <hr class="my-2">
                            <p class="mb-1 fw-semibold">Notes:</p>
                            <ul class="mb-0" style="font-size: 12px;">
                                <li><strong>Item Code</strong> must exist in Products</li>
                                <li><strong>Quality Clearance</strong>: pending / approved / rejected</li>
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <a href="{{ route('opening-stock.import.template') }}" class="btn btn-outline-secondary">
    ...
    <div class="col-md-4">
        <div class="card">
            ...
            <div class="card-body px-3" style="font-size: 13px;">
                <ol class="mb-0 ps-3">
                    <li class="mb-2">Optionally select a warehouse, or leave as Auto-Assign</li>
                    <li class="mb-2">Download the CSV template</li>
                    <li class="mb-2">Fill product Item Codes (must exist in system)</li>
                    <li class="mb-2">Save as CSV and upload</li>
                    <li class="mb-2">System auto-assigns warehouse rows via FIFO</li>
                </ol>
            </div>
        </div>
    </div>

...
<div class="d-flex justify-content-between align-items-center mb-3">
    <div>
        ...
        <small class="text-muted">Create a new product with category, group, UOM & packing</small>
    </div>
</div>
            ...
            <div class="row g-3">
                ...
                <div class="col-md-8">
                    ...
                    <input type="text"
                           ...
                           placeholder="e.g. Wheat Flour 10KG Bag"
                           required>
                    @error('name')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                    ...
                    <select name="packing_type_id"
                        ...
                        @foreach($packingTypes as $packing)
                            <option value="{{ $packing->id }}"
                                {{ old('packing_type_id') == $packing->id ? 'selected' : '' }}>
                                {{ $packing->name }}
                            </option>
                        @endforeach
                    </select>

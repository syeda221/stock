    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('roles.update', $role->id) }}" method="POST">
                ...
                <div class="mb-3">
                    <button type="button" id="selectAll" class="btn btn-sm btn-outline-secondary" {{ $role->name === 'Super Admin' ? 'disabled' : '' }}>Select All</button>
                    <button type="button" id="deselectAll" class="btn btn-sm btn-outline-secondary" {{ $role->name === 'Super Admin' ? 'disabled' : '' }}>Deselect All</button>
                </div>

                <button type="submit" class="btn btn-primary" {{ $role->name === 'Super Admin' ? 'disabled' : '' }}>Update</button>
            </form>
        </div>
    </div>
</div>

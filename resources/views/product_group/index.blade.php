...
<div class="d-flex flex-wrap justify-content-between align-items-center mb-3">
    <div>
        ...
        <h5 class="mb-0 fw-bold">Product Groups</h5>
        <small class="text-muted">Manage product grouping and organization</small>
    </div>
    ...
    <div class="d-flex align-items-center gap-2 mt-2 mt-md-0">
        ...
        <a href="{{ route('product-group.create') }}"
           class="btn btn-sm btn-primary rounded-pill shadow-sm px-3">
            <i class="bi bi-plus-lg me-1"></i> Add Product Group
        </a>
    </div>
</div>
...
<div class="card border-0 shadow-sm rounded-4 mb-3">
    <div class="card-body p-3">
        <form id="groupFilterForm" class="mb-0">
            <div class="row g-2">
                <div class="col-md-6">
                    <label class="form-label fw-semibold small">Search</label>
                    <input type="text" name="search" id="filter_search" class="form-control form-control-sm filter-field" placeholder="Search group name...">
                </div>
                <div class="col-md-3">
                ...
                <div class="col-md-3">
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <span class="ms-2 text-muted small align-self-center">Total: <strong id="totalCount">{{ $groups->count() }}</strong></span>
                    </div>
                </div>
            </div>
        </form>
                        ...
                        <tr>
                            ...
                            <td class="text-end">
                                <div class="btn-group">
                                    ...
                                    <form action="{{ route('product-group.destroy', $group->id) }}"
                                          method="POST"
                                          class="d-inline"
    ...
    function applyFilters() {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                const newTableBody = doc.querySelector('#groupTableBody');
                if (newTableBody) {
                    $('#groupTableBody').html(newTableBody.innerHTML);
                }

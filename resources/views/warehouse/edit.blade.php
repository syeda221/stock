...
<div class="d-flex justify-content-between align-items-center mb-3">
    <div>
        ...
        <h5 class="mb-0 fw-bold">Edit Warehouse</h5>
        <small class="text-muted">Update warehouse info & capacity configuration</small>
    </div>
</div>
        ...
        <form method="POST" action="{{ route('warehouse.update', $warehouse->id) }}">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-4">
                    ...
                    <select name="capacity_mode"
                            ...
                            required>
                        <option value="manual" {{ old('capacity_mode', $warehouse->capacity_mode) === 'manual' ? 'selected' : '' }}>
                            Manual Capacity
                        </option>
                        <option value="row" {{ old('capacity_mode', $warehouse->capacity_mode) === 'row' ? 'selected' : '' }}>
                            Rows & Pallets
                        </option>
                    </select>
                    @error('capacity_mode')
                ...
                <div class="col-md-4" id="manual_capacity_div">
                    ...
                    <input type="number"
                           ...
                           value="{{ old('manual_capacity', $warehouse->manual_capacity) }}"
            ...
            <div id="row_section" class="mt-4">
                            ...
                            <tbody>
                                @foreach($warehouse->rows as $i => $row)
                                    <tr>
                                        ...
                                        <td>
                                            <input type="number"
                                                   name="rows[{{ $i }}][pallet_capacity]"
                                                   value="{{ old("rows.$i.pallet_capacity", $row->pallet_capacity) }}"
                ...
                <div class="mt-3">
                    ...
                    <span id="total_capacity_preview" class="fw-bold">{{ $warehouse->total_capacity }}</span>
            ...
            <div class="form-check form-switch mt-4">
                ...
                <label class="form-check-label fw-semibold" for="statusSwitch">Active</label>
            </div>
